...
TOKEN_NUMS = 10000000
RATIO = 0.8
EN_DATA_DIR = "../outputs/dq_1024_token/data_filter.jsonl"
ZH_DATA_DIR = ''#"raw_data_zh.jsonl"
OUTPUT_FILES = "../outputs/dq_1024_token/data_sample_7b.jsonl"
...
enc = AutoTokenizer.from_pretrained("../data/models/Baichuan2-7B-Base", use_fast=False, trust_remote_code=True)
